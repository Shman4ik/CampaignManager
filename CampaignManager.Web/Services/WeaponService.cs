...
public class WeaponService(IDbContextFactory<AppDbContext> dbContextFactory, IMemoryCache _cache)
{
    ...
    public async Task<List<CloseCombatWeapon>> GetAllCloseCombatWeaponsAsync()
    {
        ...
        using AppDbContext _dbContext = await dbContextFactory.CreateDbContextAsync();
        // Если в кэше нет, получаем из базы данных
        List<CloseCombatWeapon> weapons = await _dbContext.CloseCombatWeapons.OrderBy(w => w.Name).ToListAsync();
    ...
    public async Task<List<RangedCombatWeapon>> GetAllRangedWeaponsAsync()
    {
        ...
        using AppDbContext _dbContext = await dbContextFactory.CreateDbContextAsync();
        // Если в кэше нет, получаем из базы данных
        List<RangedCombatWeapon> weapons = await _dbContext.RangedCombatWeapons.OrderBy(w => w.Name).ToListAsync();
    ...
    {
        List<CloseCombatWeapon> weapons = await GetAllCloseCombatWeaponsAsync();
    ...
    {
        List<RangedCombatWeapon> weapons = await GetAllRangedWeaponsAsync();
        return weapons.FirstOrDefault(w => w.Id == id);
    }
    ...
    {
        using AppDbContext _dbContext = await dbContextFactory.CreateDbContextAsync();
        CloseCombatWeapon? weapon = await _dbContext.CloseCombatWeapons.FindAsync(id);
        if (weapon != null)
        {
    ...
    {
        using AppDbContext _dbContext = await dbContextFactory.CreateDbContextAsync();
        RangedCombatWeapon? weapon = await _dbContext.RangedCombatWeapons.FindAsync(id);
        if (weapon != null)
        {
    ...
    private List<CloseCombatWeapon> InitializeCloseCombatWeapons()
    {
        ...
        return new List<CloseCombatWeapon>
        {
            ...
            new()
            {
                Name = "Дубина, большая (бейсбольная/крикетная бита, кочерга)",
                Skill = "Ближний бой (Драка)",
                Damage = "1D8+БП",
                Range = "Касание",
                Attacks = "1",
            ...
            new()
            {
                Name = "Дубина, малая (полицейская дубинка)",
                Skill = "Ближний бой (Драка)",
                Damage = "1D6+БП",
                Range = "Касание",
                Attacks = "1",
            ...
            new()
            {
                ...
                Attacks = "1/2",
                Cost = "$10",
                Notes = "(пронз.), Осечка 96"
            },
            new()
            {
                Name = "Гаррота*",
                Skill = "Ближний бой (Гаррота)",
                Damage = "1D6+БП",
                Range = "Касание",
                Attacks = "1",
                Cost = "$0.50",
                Notes = "*(пронз.), Особые правила"
            },
            new()
            {
                Name = "Топорик/Серп",
                Skill = "Ближний бой (Топор)",
                Damage = "1D6+1+БП",
                Range = "Касание",
                Attacks = "1",
                Cost = "$3",
            ...
            new()
            {
                Name = "Нож, средний (разделочный нож и т.п.)",
                Skill = "Ближний бой (Драка)",
                Damage = "1D4+2+БП",
                Range = "Касание",
                Attacks = "1",
            ...
            new()
            {
                Name = "Нож, малый (выкидной нож и т.п.)",
                Skill = "Ближний бой (Драка)",
                Damage = "1D4+БП",
                Range = "Касание",
                Attacks = "1",
            ...
            new()
            {
                ...
                Attacks = "2",
                Cost = "$0.50",
                Notes = "(пронз.), Однораз., Осечка 100"
            },
            new()
            {
                Name = "Копье (кавалерийская пика)",
                Skill = "Ближний бой (Копье)",
                Damage = "1D8+1",
                Range = "Касание",
                Attacks = "1",
                Cost = "$25",
            ...
            {
                Name = "Штык",
                Skill = "Ближний бой (Копье/Винтовка)",
                Damage = "1D6+БП",
                Range = "Касание",
                Attacks = "1",
                Cost = "$3.75",
                Notes = "(пронз.), Крепится к винтовке"
            },
            new()
            {
                Name = "Кинжал",
    ...
    private List<RangedCombatWeapon> InitializeRangedWeapons()
    {
        ...
        return new List<RangedCombatWeapon>
        {
            ...
            new()
            {
                Name = "Автоматический пистолет .22 Short",
                Skill = "Стрельба (П)",
                Damage = "1D6",
                Range = "10 ярдов",
                Attacks = "1 (3)",
            ...
            new()
            {
                Name = "Автоматический пистолет .32 или 7.65мм",
                Skill = "Стрельба (П)",
                Damage = "1D8",
                Range = "15 ярдов",
                Attacks = "1 (3)",
            ...
            new()
            {
                Name = "Автоматический пистолет .45",
                Skill = "Стрельба (П)",
                Damage = "1D10+2",
                Range = "15 ярдов",
                Attacks = "1 (3)",
            ...
            new()
            {
                Name = "Винтовка .22 с продольно-скользящим затвором",
                Skill = "Стрельба (В/Д)",
                Damage = "1D6+1",
                Range = "30 ярдов",
                Attacks = "1",
            ...
            new()
            {
                Name = "Карабин .30 рычажного действия",
                Skill = "Стрельба (В/Д)",
                Damage = "2D6",
                Range = "50 ярдов",
                Attacks = "1",
            ...
            new()
            {
                Name = "Винтовка Мартини-Генри .45",
                Skill = "Стрельба (В/Д)",
                Damage = "1D8+1D6+3",
                Range = "80 ярдов",
                Attacks = "1/3",
            ...
            new()
            {
                Name = "Пневматическая винтовка полковника Морана",
                Skill = "Стрельба (В/Д)",
                Damage = "2D6+1",
                Range = "20 ярдов",
                Attacks = "1/3",
            ...
            new()
            {
                Name = "Винтовка .30-06 с продольно-скользящим затвором",
                Skill = "Стрельба (В/Д)",
                Damage = "2D6+4",
                Range = "110 ярдов",
                Attacks = "1",
            ...
            new()
            {
                Name = "Дробовик 20 калибра",
                Skill = "Стрельба (В/Д)",
                Damage = "2D6/1D6/1D3",
                Range = "10/20/50 ярдов",
                Attacks = "1 или 2",
                Ammo = "2",
                Malfunction = "100",
                Cost = "$35",
            ...
            new()
            {
                Name = "Дробовик 12 калибра (полуавтоматический)",
                Skill = "Стрельба (В/Д)",
                Damage = "4D6/2D6/1D6",
                Range = "10/20/50 ярдов",
                Attacks = "1 (2)",
            ...
            new()
            {
                Name = "Дробовик 12 калибра (обрез, 2ств.)",
                Skill = "Стрельба (В/Д)",
                Damage = "4D6/1D6",
                Range = "5/10 ярдов",
                Attacks = "1 или 2",
            ...
            new()
            {
                Name = "Bergmann MP18/MP28",
                Skill = "Стрельба (ППМ)",
                Damage = "1D10",
                Range = "20 ярдов",
                Attacks = "1 (2) или авто",
                Ammo = "20/30/32",
                Malfunction = "96",
                Cost = "$1,000",
                Notes = "(пронз.)"
            ...
            new()
            {
                Name = "Автоматическая винтовка Browning M1918 (BAR)",
                Skill = "Стрельба (ПМ)",
                Damage = "2D6+4",
                Range = "90 ярдов",
                Attacks = "1 (2) или авто",
            ...
            new()
            {
                Name = "Танковая пушка 120 мм (со стаб.)",
                Skill = "Артиллерия",
                Damage = "15d10 / 4 метра",
                Range = "2000 метров",
                Attacks = "1",
                Ammo = "Отдельно",
                Malfunction = "100",
            ...
            new()
            {
                Name = "5-дюймовое корабельное орудие (со стаб.)",
                Skill = "Артиллерия",
                Damage = "12d10 / 4 метра",
                Range = "3000 метров",
                Attacks = "1",
                Ammo = "Автоподача",
                Malfunction = "98",
            ...
            new()
            {
                ...
                Skill = "Взрывчатка",
                Damage = "4d10 / 5 метров",
                Range = "На месте",
                Attacks = "На месте",
                Ammo = "Однораз.",
                Malfunction = "99",
                Cost = "Нет",
                Notes = "1920-е, Современное"
            },
            new()
            {
                Name = "Мина «Клеймор»*",
                Skill = "Взрывчатка",
                Damage = "6d6 / 20 метров",
                Range = "На месте",
                Attacks = "На месте",
                Ammo = "Однораз.",
                Malfunction = "99",
