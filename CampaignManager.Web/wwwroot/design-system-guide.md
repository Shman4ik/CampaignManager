...
Система отступов CampaignManager представляет собой стандартизированный подход к управлению пространством между элементами интерфейса с использованием классов Tailwind CSS.
...
Система типографики CampaignManager обеспечивает последовательность и иерархию текста во всем приложении, повышая читаемость и удобство использования.

### Семейства шрифтов

- **Основной шрифт**: Inter и системные шрифты без засечек используются для большинства UI-элементов
- **Шрифт с засечками**: Bookman Old Style и другие шрифты с засечками для заголовков и элементов, требующих особого внимания
...
Система типографики автоматически адаптируется под мобильные устройства, уменьшая размеры шрифтов для экранов шириной менее 640px.
