...
{
    /// <inheritdoc />
    public partial class ChangeSkillIdToGuid : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Cannot directly convert integer to uuid, so we drop and recreate the table
            // Note: This will delete all existing skill data
            // Use the /api/migration/skills/import-json endpoint to reimport skills from JSON
        ...
        {
            // Rollback: recreate table with integer ID
            migrationBuilder.DropTable(
                name: "Skills",
                schema: "games");
