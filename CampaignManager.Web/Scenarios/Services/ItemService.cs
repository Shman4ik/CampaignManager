    ...
    ILogger<ItemService> logger)
{
    ...
    public async Task<bool> UpdateItemAsync(Item item)
    {
        try
        {
            ...
            Item? existingItem = await dbContext.Items.FindAsync(item.Id);
            ...
            {
                bool nameExists = await dbContext.Items
    ...
    public async Task<bool> DeleteItemAsync(Guid id)
    {
        try
        {
            ...
            bool isUsed = await dbContext.ScenarioItems.AnyAsync(si => si.ItemId == id);
            if (isUsed)
            {
    ...
    public async Task<List<string>> GetAllItemCategoriesAsync()
    {
        try
        {
            ...
            List<string?> allCategoriesRaw = await dbContext.Items
